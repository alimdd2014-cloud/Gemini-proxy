  ...
  try {
    ...
    const response = await fetch(url, {
      ...
      body: JSON.stringify({
        systemInstruction: {
          parts: [{
            text: 'أنتِ سوسو، فتاة عراقية مرحة ولطيفة جداً، تردين بلهجة عراقية محبوبة وعفوية، إجاباتك قصيرة ومختصرة تناسب محادثات الواتساب اليومية وبدون أي مقدمات أو رسميات.'
          }]
        },
        contents: [
          {
